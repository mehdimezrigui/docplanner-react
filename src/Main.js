...
const tab=[{titre:"For patient", 
            ...
            country:["CHOOSE COUNTRY","Argentina","Australia","Bresil","Canada","France","Italy","Tunisie","UK","USA"],
            class:"box-patient",
            classimg:"box-image-patient"
            } ,
           {titre:"For doctors",
            description:"Save time managing visits and cut no-shows by half",
            image:"https://www.docplanner.com/img/screen-saas@2x.png",
            class:"box-doctor",
            classimg:"box-image-doctor"
           }
        ]
const sta=[{titre:"Leader in 10 countries",
             ...
             set:"https://www.docplanner.com/img/flag.png 1x, https://www.docplanner.com/img/flag@2x.png 2x",
             class:"box-stat stat-countries"},
            {titre:"1 million appointments",
            description:"booked last month",
            image:"https://www.docplanner.com/img/visits.png",
            set:"https://www.docplanner.com/img/visits.png 1x, https://www.docplanner.com/img/visits@2x.png 2x",
            class:"box-stat stat-appointments"},
            {titre:"30 million unique patients",
            description:"visit us every month",
            image:"https://www.docplanner.com/img/patients.png",
            set:"https://www.docplanner.com/img/patients.png 1x, https://www.docplanner.com/img/patients@2x.png 2x",
            class:"box-stat stat-patient"},
            {titre:"2 million active doctors",
            description:"trust in our solutions",
            image:"https://www.docplanner.com/img/doctors.png",
            set:"https://www.docplanner.com/img/doctors.png 1x, https://www.docplanner.com/img/doctors@2x.png 2x",
            class:"box-stat stat-doctor"}
            ]
const prov=[{titre:"Warsaw",
            image:"https://www.docplanner.com/images/warsaw.png",
            set:"https://www.docplanner.com/images/warsaw.png 1x, https://www.docplanner.com/images/warsaw@2x.png 2x"
            },
            {titre:"Barcelona",
            image:"https://www.docplanner.com/images/barcelona.png",
            set:"https://www.docplanner.com/images/barcelona.png 1x, https://www.docplanner.com/images/barcelona@2x.png 2x"
            },
            {titre:"Istanbul",
            image:"https://www.docplanner.com/images/istanbul.png",
            set:"https://www.docplanner.com/images/istanbul.png 1x, https://www.docplanner.com/images/istanbul@2x.png 2x"},
            {titre:"Rome",
            image:"https://www.docplanner.com/images/rome.png",
            set:"https://www.docplanner.com/images/rome.png 1x, https://www.docplanner.com/images/rome@2x.png 2x"},
            {titre:"Mexio City",
            image:"https://www.docplanner.com/images/mexico-city.png",
            set:"https://www.docplanner.com/images/mexico-city.png 1x, https://www.docplanner.com/images/mexico-city@2x.png 2x"},
            {titre:"Curitiba",
            image:"https://www.docplanner.com/images/curitiba.png",
            set:"https://www.docplanner.com/images/curitiba.png 1x, https://www.docplanner.com/images/curitiba@2x.png 2x"}
          ]
export default class Main extends Component {
  render() {
    return (
      <div>
        <img class="lead-logo" src={logo} alt="Docplanner"/>
        ...
        <div className="brands">
                ...
                <ul className="brands-logo">
                    <li>
                        <a href="//www.znanylekarz.pl" target="_blank">
                            <svg xmlns="http://www.w3.org/2000/svg" width="220" height="32" viewBox="0 0 220 32" className="traitement" >
            ...
            <div className="province-office">
            <h2>
                    Improve the lives of millions.
                    Change yours forever
                </h2>
                <p>
                        More than 1000 team mates share our same vision, goals and passion. With offices in Warsaw, Barcelona, Istanbul, Rome, Czech Republic, Mexico City, Colombia and Curitiba, our search for great talent never stops.
                </p>
